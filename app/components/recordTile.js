...
const RecordTile = (props) => {
    ...
    const updateLastVisited = async () => {
        ...
        try {
            ...
            // firebase.firestore().collection('Records').doc(props.id).update({
            //     lastVisitedDate: now,
            // });
        ...
        <View style={styles.container}>
            <View style={styles.left}>
                ...
                <TouchableOpacity
                    ...
                    <Text style={styles.buttonText}>Find Nearby Address</Text>
                </TouchableOpacity>
            </View>
                ...
                <View>
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            ...
                            <Text style={styles.buttonText}>Visited Today</Text>
                            {/* {() => this.props.navigation.navigate('records')} */}
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.button}>
                            <Text style={styles.buttonText}>NAH Today</Text>
                            {/* {() => this.props.navigation.navigate('records')} */}
                        </TouchableOpacity>
                    </View>
                </View>
